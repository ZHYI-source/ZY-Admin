<template>
    <div v-show="getShow">
        ...
        >
            ...
            >
                <a-input v-model:value="registerState.username" allowClear autocomplete="off" size="large"
                         placeholder="用户名">
                    <template #prefix>
            ...
            >
                <a-input-password
                        v-model:value="registerState.password" allowClear autocomplete="off" placeholder="密码"
                        size="large">
                    <template #prefix>
            ...
            >
                <div style="display: flex">
                    <a-input v-model:value="registerState.code" allowClear autocomplete="off" size="large"
                             placeholder="验证码">
                        <template #prefix>
            ...
            <a-form-item>
                <a-form-item name="remember" no-style>
                    <a-checkbox v-model:checked="registerState.remember">记住密码</a-checkbox>
                </a-form-item>
            </a-form-item>
            <a-form-item>
